    ...
    return (
        <div className="space-y-2">
            ...
            <input
                ...
                name="title"
                rows={3}
                className="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 px-2 break-all"
