...
const ClubCard = ({ club, user }) => {
    return (
        <li key={club._id} className="bg-white rounded-sm ring-[0.5px] ring-inset ring-gray-300 shadow-custom grid grid-cols-3 justify-items-center text-sm justify-between w-full p-2">
